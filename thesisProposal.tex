...
This means that the amount of data movement required per DoF decreases for matrix-free implementations while it remains relatively constant for assembled matrices.
